...
<html ng-app="storeApp">
	<head>
		...
		.NET (C#, Visual Basis), PHP, Python, JavaScript, Ajax, CSS, HTML5 and also in RDBMS like MySQL, SQL Server and Oracle.">
		...
		<meta property="og:image" content="http://adebayopeter.com/images/adebayopeterola.jpg">
		<meta property="og:description" content="My name is Adebayo Peter Olaonipekun, a software developer in Lagos Nigeria. I am skilled in .NET (C#, Visual Basis), PHP, Python, JavaScript, Ajax, CSS, HTML5 and also in RDBMS like MySQL, SQL Server and Oracle.">

		<!-- Schema.org markup for Google+ -->
		<meta itemprop="name" content="Adebayo Peter Olaonipekun | Software Developer | Database Administrator">
		<meta itemprop="description" content="My name is Adebayo Peter Olaonipekun, a software developer in Lagos Nigeria. I am skilled in .NET (C#, Visual Basis), PHP, Python, JavaScript, Ajax, CSS, HTML5 and also in RDBMS like MySQL, SQL Server and Oracle.">
		<meta itemprop="image" content="http://adebayopeter.com/images/adebayopeterola.jpg">
		...
		<meta name="twitter:description" content="My name is Adebayo Peter Olaonipekun, a software developer in Lagos Nigeria. I am skilled in .NET (C#, Visual Basis), PHP, Python, JavaScript, Ajax, CSS, HTML5 and also in RDBMS like MySQL, SQL Server and Oracle.">
		<meta name="twitter:creator" content="@adebayopekunmi">
		<meta name="twitter:image:src" content="http://adebayopeter.com/images/adebayopeterola.jpg">
