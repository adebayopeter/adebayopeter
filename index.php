		...
		<section id="hero" class="light-typo ">
			<div class="container welcome-content">
				<div class="row">
					<div class="col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12 text-center wow fadeInUp">
						<img id="logo" src="<?php echo BASE_URL; ?>img/logo.png" class="img-responsive text-center" alt="shop logo" width="300">
						...
						<a class="btn btn-store smooth-scroll" href="<?php echo BASE_URL; ?>projects/">browse my work</a>
					</div>
				</div>
			</div>
			...
			<div id="hero-slides">
				<div class="slides-container">
					<img src="<?php echo BASE_URL; ?>img/img2.jpg" alt="Adebayo Peter Olaonipekun">
					<img src="<?php echo BASE_URL; ?>img/adebayopeterola.jpg" alt="Adebayo Peter Olaonipekun">
					<img src="<?php echo BASE_URL; ?>img/server_romm.jpg" alt="Adebayo Peter Olaonipekun">
					<img src="<?php echo BASE_URL; ?>img/c2.jpg" alt="Adebayo Peter Olaonipekun">
				</div>
			</div>
		</section>
