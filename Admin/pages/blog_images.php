                ...
                <div class="box-body">
                  <ul class="lb-album">
                    <?php
                      ...
                      $selectblog = $db->query($sql2);
                      $i = 1;
                      while ($rw2 = $selectblog->fetch()) { 
                        $imagefile = $rw2['image'];
                    ?>                    
                    <li>
                      <a href="#image-<?php echo $i; ?>">
                        <img src="<?php echo BASE_URL; ?>images/blog_img/img_150_150/<?php echo $imagefile; ?>">
                        <span>Pointe</span>
                      </a>
                      <div class="lb-overlay" id="image-<?php echo $i; ?>">
                        <img src="<?php echo BASE_URL; ?>images/blog_img/img_840_451/<?php echo $imagefile; ?>" />
                        <div>
                          <?php if ($i > 1) { ?>
