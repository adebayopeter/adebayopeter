...
<head>
    ...
    <title>Admin | adebayopeter.com</title>
    <!-- Favicon -->
    ...
    <div id="app">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Add New App</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseMedia" class="collapse" aria-labelledby="headingMedia" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="">All Media</a>
                            <a class="collapse-item" href="">Upload Media</a>
                        </div>
                    </div>
                </li>
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img src="{{Auth::user()->photo ? Auth::user()->photo->file : '/images/Sample.jpg'}}" alt="" width="60px" class="img-profile rounded-circle"> --}}
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                ...
                {{-- <span>Copyright &copy; {{StringUtils::test()}} {{Carbon::now()->year}}</span> --}}
                </div>
                </div>
            </footer>
            <!-- End of Footer -->
